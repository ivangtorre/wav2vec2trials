...
RESULT_DIR=$RESULT_DIR/BATCH-$BATCH_SIZE.EPOCH-$EPOCHS.FDROP-$FEAT_PROJ_DROPOUT.LDROP-$LAYER_DROPOUT.HDROP-$HIDDEN_DROPOUT.ACDROP-$ACTIVATION_DROPOUT.ATDROP-$ATTENTION_DROPOUT.-$DATESTAMP
mkdir -p "$RESULT_DIR"
