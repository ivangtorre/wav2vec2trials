...
##### PARAMETERS ##################################
DATA_DIR=${1:-${DATA_DIR:-"/data/CORPORA/ACOUSTIC_CORPUS/APHASIA/english/2021_06_24/data/"}}  # The folder where audios are stored
LANGUAGE=${2:-${LANGUAGE:-"english"}} # Language
DATASET=${2:-${DATASET:-"/data/CORPORA/ACOUSTIC_CORPUS/APHASIA/english/2021_06_24/df_train.csv"}}  # Train Dataset Location
DATASET_EVAL=${2:-${DATASET_EVAL:-"/data/CORPORA/ACOUSTIC_CORPUS/APHASIA/english/2021_06_24/df_eval.csv"}}  # Eval Dataset Location
